 ...
 * diamond_frontend — the second file behind the id collision that
 * `registry/diamond-frontend/pr-loop-analyzer.ts` warns about.
 *
...
export const manifest: AgentManifest = {
	...
	notes: [
		"Shares a filename with the pr-loop-analyzer COMMAND but not its behaviour or write scope. Reconciling the two files in diamond_frontend would let this overlay be deleted.",
